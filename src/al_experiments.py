...
from al_experiments.accuracy import Accuracy, create_cross_acc_breaking, create_softmax_fn, create_top_k_sampling, greedy_cross_acc, greedy_rmse, knapsack_cross_acc, knapsack_rmse, select_best_idx
...
experiment_configs = [
    ExperimentConfig(
        ...
        thresh_breaking_conditions=[ThreshBreakingCondition('until_cross_acc_1_00', create_cross_acc_breaking(1.00))], # leave one if no breaking cond is needed (instance wise)
